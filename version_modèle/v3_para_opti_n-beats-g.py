...
def train_generic_nbeats(dataset, input_size, forecast_size, epochs=100, batch_size=16, lr=0.001, loss_fn='smape'):
...
def evaluate_model(model, test_dataset, loss_fn='smape'):
